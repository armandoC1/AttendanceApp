...
@Configuration
@EnableWebSecurity
public class DataBaseWebSiteSecurity {
    @Bean
    ...
    public SecurityFilterChain filterChain (HttpSecurity http) throws Exception {
        ...
        //aperturar el acceso a los recursos estaticos
                        .requestMatchers("assetrs/**", "css/**", "js/**").permitAll()
                //las vistas publicas no requieren autorizacion
                        .requestMatchers("/", "/privacy", "/items").permitAll()
                //todas las deas vistas requieren autorizacion
